 ...
 * 
 * Class Navigation_Admin_MenugroupController
 * 
 ...
 */
class Navigation_Admin_MenugroupController extends Fox_Admin_Controller_Action {
    ...
    function indexAction() {
        $this->loadLayout();
        $view = Fox::getView('navigation/admin/menugroup');
        if ($view) {
            $this->_addContent($view);
        }
        $view->setHeaderText('Manage Menu Groups');
        $this->renderLayout();
    }
    ...
    public function editAction() {
        $this->loadLayout();
        $view = Fox::getView('navigation/admin/menugroup/add');
        if ($view) {
            $this->_addContent($view);
        }
        ...
        if ($id) {
            ...
            $model->load($id);
            if ($model->getId()) {
                $view->setHeaderText('Edit Menu Group "' . $model->getName() . '"');
            } else {
                $view->setHeaderText('Add Menu Group');
            }
        } else {
            $view->setHeaderText('Add Menu Group');
        }
    ...
    public function ajaxTableAction() {
        $view = Fox::getView('navigation/admin/menugroup/table');
        if ($view) {
